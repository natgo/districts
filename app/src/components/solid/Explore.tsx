...
export function ExplorePage() {
  ...
  return (
    <main class="mx-auto flex flex-col items-center p-4 text-center text-gray-700">
      <h1 class="max-6-xs my-16 text-6xl font-thin uppercase text-sky-700">Explore locked</h1>
      <h2 class="my-6 text-xl font-semibold">Enter your E-mail to continue</h2>
      <form class="flex items-center gap-2">
        ...
        <button
          ...
          onClick={() => {
            setDisabled(true);
            setTimeout(() => {
              alert("It looks like you don't have the license to use this feature 💀");
            }, Math.random() * 10000);
          }}
        >
          {disabled() ? (
