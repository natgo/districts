...
wget -O vaalialueet.json "https://kartta.hel.fi/ws/geoserver/avoindata/wfs?SERVICE=WFS&VERSION=1.1.0&REQUEST=GetFeature&TYPENAME=avoindata:Halke_aanestysalue&SRSNAME=urn:x-ogc:def:crs:EPSG:4326&OUTPUTFORMAT=json"
